...
parser.add_argument('-e', '--extention',  default='txt', type=str, help='Specificy the file type you would like to index.')
...
raw_file_names = [f for f in os.listdir(args.directory_path) if os.path.isfile(os.path.join(args.directory_path, f)) and f.endswith(args.extention)]
